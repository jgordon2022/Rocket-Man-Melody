...
int melody[] = {
  0, NOTE_A4, NOTE_C4, NOTE_A4, 
  NOTE_C4, NOTE_A4, NOTE_C4, 
  NOTE_A4, NOTE_C4, NOTE_D4, 0,
  0,
  NOTE_C4, NOTE_A4, NOTE_C4, NOTE_A4, 
  0, NOTE_C4, NOTE_D4, NOTE_C4,
  NOTE_D4, 0,
  0,
  0, NOTE_A4, NOTE_A4, NOTE_C4, NOTE_C4, NOTE_E4, 
  NOTE_G4, NOTE_C5, 
  NOTE_E4, NOTE_D4, NOTE_C4, NOTE_D4, 
  0, NOTE_A4, NOTE_G4, NOTE_C4, NOTE_G4, 
  NOTE_G5, 
  0,
  0, NOTE_A4, NOTE_C4, NOTE_A4, NOTE_C4
